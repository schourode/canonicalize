...
namespace Canonicalize.Strategies
{
    ...
    public sealed class PatternStrategy : IUrlStrategy
    {
        ...
        /// <summary>
        /// Initializes a <see cref="PatternStrategy"/> with a specific regular expression and replacement string.
        /// </summary>
        ...
        public PatternStrategy(string regex, string replacement)
        {
